...
class VetoresMilhaoTest {
	...
	String quantidadeElementos = "um milhao ";
	...
	void insertionSortQuaseOrganizado() {
		...
		System.out.println(tipoAlgoritmo + quantidadeElementos + organizacaoVetor + " int: " + (tempoFinal - tempoInicial) + "ms");
		
		tempoInicial = System.currentTimeMillis();
		boolean teste2 = Arrays.equals(checkFloat, insertion.metodoDeOrdenacaoFloat(vetorFloat));
		tempoFinal = System.currentTimeMillis();
		System.out.println(tipoAlgoritmo + quantidadeElementos + organizacaoVetor + " float: " + (tempoFinal - tempoInicial) + "ms");
		
		tempoInicial = System.currentTimeMillis();
		boolean teste3 = Arrays.equals(checkDouble, insertion.metodoDeOrdenacaoDouble(vetorDouble));
		tempoFinal = System.currentTimeMillis();
		System.out.println(tipoAlgoritmo + quantidadeElementos + organizacaoVetor + " double: " + (tempoFinal - tempoInicial) + "ms");
		System.out.println("");
